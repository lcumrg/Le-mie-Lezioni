...
export default function CalendarioPage() {
  ...
  // Auto-generate lessons when opening a week with no lessons but with orari
  useEffect(() => {
    ...
    handleGenerate()
  }, [loading, annoAttivo, lezioni.length, orari.length, start, generating])

  // Mark all pianificate lessons for a day as svolte
